...
predoverall <- predfunc(impdata = imprsdata, nomodvars = "scream_id")
...
# ref
impref <- miceadds::subset_datlist(imprsdata, subset = c(rsdata$shf_ef_cat == "HFrEF"))

predref <- predfunc(impdata = impref, nomodvars = c("shf_ef_cat", "scream_id"))

# mref
impmref <- miceadds::subset_datlist(imprsdata, subset = c(rsdata$shf_ef_cat == "HFmrEF"))

predmref <- predfunc(impdata = impmref, nomodvars = c("shf_ef_cat", "scream_id"))

# pef
imppef <- miceadds::subset_datlist(imprsdata, subset = c(rsdata$shf_ef_cat == "HFpEF"))
